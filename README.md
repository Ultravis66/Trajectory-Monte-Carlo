...
#EDIT: I have been playing around with the Aero Tables; current design space trim AoA is ~14° from the given Cm,alpha table. If you edit the tables and want to see what happens at higher Angles of Attack, the design space is capped at 16°, you will need to update the aero tables accordingly.
